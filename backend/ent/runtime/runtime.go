...
func init() {
	...
	// groupDescSystemPromptStrategy is the schema descriptor for system_prompt_strategy field.
	groupDescSystemPromptStrategy := groupFields[37].Descriptor()
	// group.DefaultSystemPromptStrategy holds the default value on creation for the system_prompt_strategy field.
	group.DefaultSystemPromptStrategy = groupDescSystemPromptStrategy.Default.(string)
	// group.SystemPromptStrategyValidator is a validator for the "system_prompt_strategy" field. It is called by the builders before save.
	group.SystemPromptStrategyValidator = groupDescSystemPromptStrategy.Validators[0].(func(string) error)
